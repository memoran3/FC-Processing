...
date         <- 20250507 # the date of the experiment YEAR/MONTH/DAY                ## changed this based on provided data set
run          <- "PM"     # the run number for the date                              ## changed this based on provided data set
# csv          <- read.csv(paste0("./data_labels/",strsplit(fn[1], ".TXT"),".csv"))
csv <- read.csv("./data_labels/Label-Template.csv") ## changed this based on data set 
...
# ### Checking file structures for inputs
# list.files("data_raw")
# list.files("data_labels")
# getwd()
# dir.exists("data_raw")
# getwd()
# list.files("data_raw")
